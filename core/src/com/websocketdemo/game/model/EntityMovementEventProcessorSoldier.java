...
public class EntityMovementEventProcessorSoldier implements IEntityMovementEventProcessor {
	
	private SoldierEntity m_Entity;
	
	public EntityMovementEventProcessorSoldier(IEntity iEntity){
		m_Entity = (SoldierEntity) iEntity;
	}
